export const metadata = {
  title: "Stránka nenalezena | Psycholog FM"
};
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center gap-6 px-6 py-20 text-center">
      <div className="flex flex-col items-center gap-3">
        <img src="/Menu_Logo.svg" alt="Psycholog FM" className="h-20 w-20" loading="lazy" />
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primaryBlue">Psycholog FM</p>
      </div>
