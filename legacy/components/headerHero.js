export function HeaderHero() {
  return `
    <section class="relative rounded-3xl border border-borderLight bg-white/80 p-8 shadow-soft md:p-12 reveal" data-reveal>
      <div class="max-w-2xl space-y-6">
        <p class="text-sm font-semibold uppercase tracking-[0.2em] text-primaryBlue">Psychologfm.cz</p>
        <h2 class="text-3xl font-semibold tracking-tight text-textDark md:text-4xl">
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <a
            href="#o-mne"
            class="rounded-full border border-primaryBlue px-6 py-3 text-sm font-semibold text-primaryBlue transition hover:bg-softBlue/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-warmAmber"
